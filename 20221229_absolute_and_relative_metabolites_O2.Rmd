...
ratio_O2%>% 
  subset(Bacteria %in% c("Bacteroides_faecis", "Bacteroides_ovatus", "Eubacterium_eligens", "Bacteroides_xylanisolvens", "Bacteroides_fragilis", "Clostridium_sporogenes", "Collinsella_aerofaciens",  "Prevotella_copri"   )) %>%
