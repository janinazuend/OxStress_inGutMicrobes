...
###
bacteroidetes<-grep("Phocaei", bacteria_pyla$Bacteria)
...
ratio_O2<-left_join(ratio_O2, bacteria_pyla, by= "Bacteria")
...
ratio_O2%>%
  subset(Bacteria %in% c("Anaerostipes_caccae", 
                         ...
                         "Ruminococcus_gnavus", "Bacteroides_xylanisolvens",  "Prevotella_copri")) %>%
           subset(agar_condition %in% c("minimal agar (''MIC'')"))->sub_nic


ratio_O2%>% 
  subset(Bacteria %in% c("Bacteroides_faecis", "Bacteroides_ovatus", "Eubacterium_eligens", "Bacteroides_fragilis", "Clostridium_sporogenes", "Collinsella_aerofaciens"   )) %>%
...
max<-max(selection$ratio)
min<-min(selection$ratio)
...
stats_absolute%>%
  subset(Bacteria %in% c("Anaerostipes_caccae", 
                         ...
                         "Phascolarctobacterium_faecium", 
                         "Roseburia_intestinalis"   ,
                         "Ruminococcus_gnavus",  "Prevotella_copri", "Collinsella_aerofaciens")) %>%
           subset(agar_condition %in% c("minimal agar (''MIC'')"))->sub_nic


stats_absolute%>%

subset(Bacteria %in% c("Bacteroides_faecis", "Bacteroides_ovatus", "Eubacterium_eligens", "Bacteroides_fragilis", "Clostridium_sporogenes", "Parabacterium_merdae"  ,"Bacteroides_xylanisolvens",
                         "Blautia_hydrogenotrophica"   )) %>%
           subset(agar_condition %in% c("agar with highest growth"))->sub_nic_1
