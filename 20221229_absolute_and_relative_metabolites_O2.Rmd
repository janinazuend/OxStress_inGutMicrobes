...
highest<-c("Lachnospira eligens","Agathobacter rectalis","Bacteroides intestinalis","Prevotella copri",  "Bacteroides faecis", "Bacteroides uniformis","Bacteroides ovatus" ,"Dorea longicatena")
...
order_o2%>%
  mutate(bacteria = ifelse(bacteria == "Eubacterium eligens", "Lachnospira eligens", bacteria))->order_o2
