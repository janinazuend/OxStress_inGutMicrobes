...
```{r}
#calculate means & sd
mean_metabolites <- aggregate(HPLC_relative_long$concentration, list(HPLC_relative_long$assay, HPLC_relative_long$condition, HPLC_relative_long$metabolite), FUN=mean, na.rm=T)
...
ratio%>% 
  subset(Bacteria %in% c("Eubacterium limosum",
                         "Roseburia intestinalis", "Blautia hydrogenotrophica", "Faecalibacterium prausnitzii")) %>%
