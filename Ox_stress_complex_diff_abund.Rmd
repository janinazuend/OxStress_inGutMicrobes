...
out%>%
 ...
 scale_fill_gradientn(colors = c( "coral", "white", "cyan4"),  na.value= "grey", 
                      values = rescale(c(-6, 0, 6)), limits=c(-6, 6), 
                      name="Clr-difference")+
...
filter_decreased<-c("Bacteroides", "Fusicatenibacter", "Anaerostipes", 
             ...
             "[Eubacterium] hallii group",   "[Ruminococcus] gauvreauii group",
             "Parabacteroides")

filter_increased<-c("Enterobacteriaceae Family", "Escherichia-Shigella","Enterococcus", "Bifidobacterium", "Lactobacillales Order")
# , "Streptococcus"
