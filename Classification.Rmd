...
df_abund_class%>%
  ...
  subset(stress %in% c("O2") | time %in% "pre-stress")%>%
...
butyrate_producers%>%
  ...
  mutate(xmax = ifelse(time == "post_stress_1", 2.8, xmax),
         xmin = ifelse(time == "post_stress_1", 3.2, xmin))->stat_test
