...
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" | 
              (stress_level %in% "max" & stress %in% "O2" & incubation %in% "aerobe" & time %in% c("stress", "post_stress_1")))->phyloseq
...
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" | 
              (stress_level %in% "max" & stress %in% "O2" & incubation %in% "anaerobe" & time %in% c("stress", "post_stress_1")))->phyloseq
...
p_hist$data%>%
  ...
  scale_y_continuous(breaks=c(0.25, 0.5, 0.75))+
  scale_x_discrete(labels=c( "Pre-culture", "Stress", "Post-stress"))+
  force_panelsizes(rows =unit(4, "cm"), cols=unit(4, "cm"))->O2_max_anaerobe
...
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" | 
              (stress_level %in% "median" & stress %in% "O2" & incubation %in% "aerobe" & time %in% c("stress", "post_stress_1")))->phyloseq
...
p_hist$data%>%
  ...
  scale_y_continuous(breaks=c(0.25, 0.5, 0.75))+
  scale_x_discrete(labels=c( "Pre-culture", "Stress", "Post-stress"))+
  force_panelsizes(rows =unit(4, "cm"), cols=unit(4, "cm"))->O2_median_anaerobe
...
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" | 
              (stress_level %in% "control" & stress %in% "O2" & incubation %in% "aerobe" & time %in% c("stress", "post_stress_1")))->phyloseq
...
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" | 
              (stress_level %in% "control" & stress %in% "O2" & incubation %in% "anaerobe" & time %in% c("stress", "post_stress_1")))->phyloseq
...
p_hist$data%>%
  ...
  scale_y_continuous(breaks=c(0.25, 0.5, 0.75))+
  scale_x_discrete(labels=c( "Pre-culture", "Stress", "Post-stress"))+
  force_panelsizes(rows =unit(4, "cm"), cols=unit(4, "cm"))->O2_control_anaerobe
...
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" | 
              (stress_level %in% "low" & stress %in% "O2" & incubation %in% "aerobe" & time %in% c("stress", "post_stress_1")))->phyloseq
...
p_hist$data%>%
  ...
  scale_y_continuous(breaks=c(0.25, 0.5, 0.75))+
  scale_x_discrete(labels=c( "Pre-culture", "Stress", "Post-stress"))+
  force_panelsizes(rows =unit(4, "cm"), cols=unit(4, "cm"))->O2_low
...
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" | 
              (stress_level %in% "low" & stress %in% "O2" & incubation %in% "anaerobe" & time %in% c("stress", "post_stress_1")))->phyloseq
...
p_hist$data%>%
  ...
  scale_y_continuous(breaks=c(0.25, 0.5, 0.75))+
  scale_x_discrete(labels=c( "Pre-culture", "Stress", "Post-stress"))+
  force_panelsizes(rows =unit(4, "cm"), cols=unit(4, "cm"))->O2_low_anaerobe
...
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" | 
              (stress_level %in% "high" & stress %in% "O2" & incubation %in% "aerobe" & time %in% c("stress", "post_stress_1")))->phyloseq
...
p_hist$data%>%
  ...
  scale_y_continuous(breaks=c(0.25, 0.5, 0.75))+
  scale_x_discrete(labels=c( "Pre-culture", "Stress", "Post-stress"))+
  force_panelsizes(rows =unit(4, "cm"), cols=unit(4, "cm"))->O2_high
...
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" | 
              (stress_level %in% "high" & stress %in% "O2" & incubation %in% "anaerobe" & time %in% c("stress", "post_stress_1")))->phyloseq
...
p_hist$data%>%
  ...
  scale_y_continuous(breaks=c(0.25, 0.5, 0.75))+
  scale_x_discrete(labels=c( "Pre-culture", "Stress", "Post-stress"))+
  force_panelsizes(rows =unit(4, "cm"), cols=unit(4, "cm"))->O2_high_anaerobe
...
grid.arrange(O2_control+theme(legend.position = "none", 
             ...
             O2_low+theme(legend.position = "none", 
                               strip.text = element_blank(),
                           axis.text.x = element_blank(),
                           axis.title.x = element_blank(),
                           axis.ticks.x = element_blank(),
                           plot.margin = unit(c(0, 4, 0, 4), "pt")),
             O2_median+theme(legend.position = "none", 
                               strip.text = element_blank(),
                           axis.text.x = element_blank(),
                           axis.title.x = element_blank(),
                           axis.ticks.x = element_blank(),
                           plot.margin = unit(c(0, 4, 0, 4), "pt")),
             O2_high+theme(legend.position = "none", 
                               strip.text = element_blank(),
                           axis.text.x = element_blank(),
                           axis.title.x = element_blank(),
                           axis.ticks.x = element_blank(),
...
grid.arrange(O2_control_anaerobe+theme(legend.position = "none", 
                           axis.text.x = element_blank(),
                           axis.title.x = element_blank(),
                           axis.ticks.x = element_blank(),
                           plot.margin = unit(c(4, 4, 0, 4), "pt")),
             O2_low_anaerobe+theme(legend.position = "none", 
                               strip.text = element_blank(),
                           axis.text.x = element_blank(),
                           axis.title.x = element_blank(),
                           axis.ticks.x = element_blank(),
                           plot.margin = unit(c(0, 4, 0, 4), "pt")),
             O2_median_anaerobe+theme(legend.position = "none", 
                               strip.text = element_blank(),
                           axis.text.x = element_blank(),
                           axis.title.x = element_blank(),
                           axis.ticks.x = element_blank(),
                           plot.margin = unit(c(0, 4, 0, 4), "pt")),
             O2_high_anaerobe+theme(legend.position = "none", 
                               strip.text = element_blank(),
                           axis.text.x = element_blank(),
                           axis.title.x = element_blank(),
                           axis.ticks.x = element_blank(),
                           plot.margin = unit(c(0, 4, 0, 4), "pt")),
          O2_max_anaerobe + theme ( legend.position = "none", 
                          strip.text = element_blank(),
                          axis.title.x = element_blank(),
                          # axis.text.x = element_blank(),
                           axis.ticks.x = element_blank(),
...
ggsave(grid, filename = paste( "O2_legend_anaerobe.jpeg"),
       path = "C:/Users/zuendj/Desktop/03_data R/wp2_complex/output/final",
       width = 35,
       height =35,
       units = c("cm"))
```
###bar plots H2O2
#H2O2 bar - control stress
```{r}
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" | 
            (stress_level %in% c("control") & stress %in% c("H2O2") & time %in% c("stress", "post_stress_1")))->phyloseq_controls 
...
#H2O2 bar - high stress
```{r}
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" |     (stress_level %in% c("high") & stress %in% c("H2O2") & time %in% c("stress", "post_stress_1")))->phyloseq_high 
...
phyloseq_high%>%
 ...
 sample_data(phyloseq_high)<-meta
...
#H2O2 bar - median stress
```{r}
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" | 
            (stress_level %in% c("median") & stress %in% c("H2O2") & time %in% c("stress", "post_stress_1")))->phyloseq_median
...
phyloseq_median%>%
 ...
 sample_data(phyloseq_median)<-meta
...
phyloseq_rare%>%
  subset_samples(time %in% "pre-stress" | 
            (stress_level %in% c("low") & stress %in% c("H2O2") & time %in% c("stress", "post_stress_1")))->phyloseq_low 
